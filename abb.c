...
// void _BFS_abb(t_no* no, int tamanho, t_imprimir_abb impressora){
//     t_fila* descobertos = criar_fila();
//     int nro_descobertos=0;
//     enfileirar(descobertos, no);
//     while(!vazia_fila(descobertos)){
//         no = desenfileirar(descobertos);
//         if (no == NULL){
//             if (nro_descobertos < tamanho){
//                 printf("null,");
//             }
//         }else{
//             nro_descobertos++;
...
//                 printf(",");
//             }
//             enfileirar(descobertos, no->sae);
//             enfileirar(descobertos, no->sad);
//         }
//     }
// }

// void BFS_abb(t_abb* abb){

//     _BFS_abb(abb->raiz,abb->tamanho, abb->impressora);
